  ...
  describe Xcodeproj::Project do
    ...
    describe "Formatting pbxproj output" do
      ...
      it "output an encoding preamble" do
        @output.should.include "// !$*UTF8*$!\n"
      end

      it "output the archive version" do
        @output.should.include "archiveVersion = 1;"
      end

      it "output the classes" do
        @output.should.include "\tclasses = {\n\t};"
      end

      it "output the object version" do
        @output.should.include "objectVersion = 45;"
      end

      it "output the root object" do
        @output.should.include "rootObject = E525238316245A900012E2BA /* Project object */;"
      end
      ...
      it "output PBXAggregateTarget objects" do
        @output.should.include "E550D6AA16371AF600A003E9"
      end

      it "output PBXBuildFile objects" do
        @output.should.include "E525239116245A900012E2BA"
        @output.should.include "E525239B16245A900012E2BA"
        @output.should.include "E525239D16245A900012E2BA"
        @output.should.include "E550D84B16371BD000A003E9"
        @output.should.include "E5FBB2D116357C16009E96B0"
      end
      ...
      it "output XCVersionGroup objects" do
        @output.should.include "E52523AB16245A910012E2BA"
        @output.should.include "E525241116245AB20012E2BA"
        @output.should.include "E5D464AB163578AC006A4730"
        @output.should.include "E5D464AE163578C7006A4730"
        @output.should.include "E5D464B216357954006A4730"
      end
